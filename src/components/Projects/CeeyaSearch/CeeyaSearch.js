        ...
        <Container className="Two-Column-Container">
          <Row>
              ...
              <Col md={5} lg={6}>
                  ...
                  <p>😪 Through search.connect, traffic to Ceeya.io increased by 70%</p>
                  <p> 🗣 Put ceeya at the top of google search page with keywords "coach" and "personal branding".</p>
