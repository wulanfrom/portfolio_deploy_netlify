...
export default function OtherProjects() {
    ...
    const desc = {
        ...
        colorArt: "Visualizing the Colors used by the Century's Most Influential Painters",
  ...
  return (
    <div>
        ...
        <div>
          <SectionTitle line1="Relevant" line2="Works" desc="UX DESIGN // MOBILE DESIGN // WEB DEVELOPMENT // ILLUSTRATION" />
        </div>
